...
Additional security layers like [selinux](http://selinuxproject.org/page/Main_Page)
can be used with the containers.  A container should support setting selinux process
and mount labels if provided in the configuration.
